...
This markup are compiled to JavaScript code by tools like Babel. Is batter that React API craeteElement, becouse it is more intuitive and easier to read.
When the JSX is complied, it returns a plain JavaScript object, and such as function can't return two objects if they are not included in an array, the same goes for the JSX and you cannot return more than one JSX tag without wrapping it in another tag or fragment. 
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=03%3A%20Using%20JSX&em=gabriel.rodriguez.cerullo%40gmail.com).
