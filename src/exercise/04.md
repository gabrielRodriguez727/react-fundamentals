...
They are functions that return JSX and have the name capitalized, the capitalization is so that React can differentiate an HTML tag from a component.

Prop-Types: Adds runtime type cheking for React props and similar objects. 
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=04%3A%20Creating%20custom%20components&em=gabriel.rodriguez.cerullo%40gmail.com).
